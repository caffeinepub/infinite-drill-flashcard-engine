const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/AITeacher-Da3SMeDY.js","assets/index-d1c5XO2W.js","assets/index-DsyLN-sL.css","assets/scroll-area-hX2pirAF.js","assets/x-BSM6iuxa.js","assets/send-CTAAiUlg.js"])))=>i.map(i=>d[i]);
import { j as jsxRuntimeExports, L as Link, r as reactExports, _ as __vitePreload } from "./index-d1c5XO2W.js";
import { N as NavBar } from "./NavBar-BR_djSqx.js";
const AITeacher = reactExports.lazy(
  () => __vitePreload(() => import("./AITeacher-Da3SMeDY.js"), true ? __vite__mapDeps([0,1,2,3,4,5]) : void 0).then((m) => ({ default: m.AITeacher }))
);
