const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/AITeacher-BsNO7PO6.js","assets/index-VyNBnJo7.js","assets/index-95G76_UF.css","assets/scroll-area-C07wLzgY.js","assets/x-CzdkRmk6.js","assets/send-D58btLs8.js"])))=>i.map(i=>d[i]);
import { j as jsxRuntimeExports, L as Link, r as reactExports, _ as __vitePreload } from "./index-VyNBnJo7.js";
import { N as NavBar } from "./NavBar-DhLmtET-.js";
const AITeacher = reactExports.lazy(
  () => __vitePreload(() => import("./AITeacher-BsNO7PO6.js"), true ? __vite__mapDeps([0,1,2,3,4,5]) : void 0).then((m) => ({ default: m.AITeacher }))
);
