const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/AITeacher-uBIK1Z-n.js","assets/index-C7lj-2mW.js","assets/index-BlkGGmCs.css","assets/scroll-area-9ziTJ2VE.js","assets/x-DQxlQZEO.js","assets/send-BAqsuv6f.js"])))=>i.map(i=>d[i]);
import { j as jsxRuntimeExports, L as Link, r as reactExports, _ as __vitePreload } from "./index-C7lj-2mW.js";
import { N as NavBar } from "./NavBar-CfOo71OI.js";
const AITeacher = reactExports.lazy(
  () => __vitePreload(() => import("./AITeacher-uBIK1Z-n.js"), true ? __vite__mapDeps([0,1,2,3,4,5]) : void 0).then((m) => ({ default: m.AITeacher }))
);
