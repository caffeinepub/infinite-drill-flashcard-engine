const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/AITeacher-CqEhMLxF.js","assets/index-CRFmjhp7.js","assets/index-BlkGGmCs.css","assets/scroll-area-Dzl84IZv.js","assets/x-DAIz1dUU.js","assets/send-gj_EEi7D.js"])))=>i.map(i=>d[i]);
import { j as jsxRuntimeExports, L as Link, r as reactExports, _ as __vitePreload } from "./index-CRFmjhp7.js";
import { N as NavBar } from "./NavBar-qh3AYWhv.js";
const AITeacher = reactExports.lazy(
  () => __vitePreload(() => import("./AITeacher-CqEhMLxF.js"), true ? __vite__mapDeps([0,1,2,3,4,5]) : void 0).then((m) => ({ default: m.AITeacher }))
);
