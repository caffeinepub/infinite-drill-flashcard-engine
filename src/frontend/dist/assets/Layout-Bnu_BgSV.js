const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/AITeacher-CZJIIDOm.js","assets/index-C2oN9xVs.js","assets/index-DsyLN-sL.css","assets/scroll-area-DPoLhTI5.js","assets/x-DOcWQEc4.js","assets/send-C4Uevjmz.js"])))=>i.map(i=>d[i]);
import { j as jsxRuntimeExports, L as Link, r as reactExports, _ as __vitePreload } from "./index-C2oN9xVs.js";
import { N as NavBar } from "./NavBar-Dv2nwU6k.js";
const AITeacher = reactExports.lazy(
  () => __vitePreload(() => import("./AITeacher-CZJIIDOm.js"), true ? __vite__mapDeps([0,1,2,3,4,5]) : void 0).then((m) => ({ default: m.AITeacher }))
);
