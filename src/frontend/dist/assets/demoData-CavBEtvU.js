const carbonQuestions = [
  {
    ...
    correctIndex: 1,
    explanation: "CH₃-CH₂-OH contains 2 carbon atoms with a hydroxyl (-OH) group, making it Ethanol (eth = 2 carbons, -ol suffix for alcohol)."
  },
  {
    id: 2,
    ...
    correctIndex: 2,
    explanation: "Carboxylic acids are characterized by the -COOH (carboxyl) group, which consists of a carbonyl group (C=O) bonded to a hydroxyl group (-OH)."
  },
  {
    id: 3,
    question: "What type of reaction occurs when ethanol reacts with ethanoic acid?",
    options: ["Substitution", "Esterification", "Saponification", "Combustion"],
    correctIndex: 1,
    explanation: "When an alcohol reacts with a carboxylic acid in the presence of a catalyst (H₂SO₄), an ester is formed. This reaction is called Esterification."
  },
  {
    id: 4,
    question: "The process of converting soap into glycerol and fatty acid salts is called:",
    options: ["Esterification", "Hydrogenation", "Saponification", "Oxidation"],
    correctIndex: 2,
    explanation: "Saponification is the hydrolysis of fats/oils using a strong base (NaOH/KOH) to produce glycerol and fatty acid salts (soap)."
  },
  {
    id: 5,
    ...
    correctIndex: 3,
    explanation: "Ethane (C₂H₆) is a saturated hydrocarbon (alkane) because all carbon-carbon bonds are single bonds. Ethylene has a double bond, acetylene has a triple bond, and benzene has delocalized bonds."
  },
  {
    id: 6,
    ...
    correctIndex: 1,
    explanation: "Alkenes have the general formula CₙH₂ₙ because they contain one C=C double bond, which reduces the hydrogen count by 2 compared to alkanes (CₙH₂ₙ₊₂)."
  },
  {
    id: 7,
    question: "Which property of carbon allows it to form long chains and rings?",
    options: ["Valency", "Catenation", "Isomerism", "Hybridization"],
    correctIndex: 1,
    explanation: "Catenation is the unique property of carbon that allows carbon atoms to bond with each other to form long chains, branched chains, and rings — the basis of organic chemistry."
  },
  {
    id: 8,
    ...
    correctIndex: 1,
    explanation: "CH₃COOH has 2 carbons with a -COOH group. The IUPAC name uses 'eth-' (2 carbons) + '-anoic acid', giving Ethanoic acid (commonly known as acetic acid)."
  },
  {
    id: 9,
    question: "Which of the following reactions describes the addition of hydrogen to an unsaturated compound?",
    options: ["Combustion", "Substitution", "Hydrogenation", "Fermentation"],
    correctIndex: 2,
    explanation: "Hydrogenation is the addition of H₂ gas to an unsaturated compound (alkene/alkyne) in the presence of a catalyst (Ni, Pt, Pd) to form a saturated compound."
  },
  {
    id: 10,
    ...
    correctIndex: 1,
    explanation: "When ethanol (CH₃CH₂OH) is oxidized (using alkaline KMnO₄ or acidified K₂Cr₂O₇), it is converted to ethanoic acid (CH₃COOH), an example of oxidation in organic chemistry."
  }
];
const carbonFlashcards = [
  {
    id: 1,
...
const carbonCheatsheet = [
  {
    id: 1,
    type: "Definition",
    icon: "📖",
    title: "Catenation",
    content: "Property of carbon to form bonds with other carbon atoms. Unique to carbon due to its small size and tetravalency."
  },
  {
    id: 2,
    type: "Formula",
    ...
    content: "Alkanes: CₙH₂ₙ₊₂ | Alkenes: CₙH₂ₙ | Alkynes: CₙH₂ₙ₋₂ | Alcohols: CₙH₂ₙ₊₁OH | Carboxylic Acids: CₙH₂ₙ₊₁COOH"
  },
  {
    id: 3,
    type: "Definition",
    ...
    content: "-OH (Hydroxyl/Alcohol) | -COOH (Carboxyl/Acid) | -CHO (Aldehyde) | -CO- (Ketone) | -NH₂ (Amine) | C=C (Alkene)"
  },
  {
    id: 4,
    type: "Example",
    ...
    content: "CH₃COOH + C₂H₅OH → CH₃COOC₂H₅ + H₂O (with conc. H₂SO₄ catalyst). Ethanoic acid + Ethanol → Ethyl ethanoate (a sweet-smelling ester)"
  },
  {
    id: 5,
    type: "Tip",
    ...
    content: "My Elephant Paddy Beats Paddy Hard = Meth(1), Eth(2), Prop(3), But(4), Pent(5), Hex(6). Add suffix: -ane/-ene/-yne/-ol/-al/-oic acid based on functional group."
  },
  {
    id: 6,
    type: "Formula",
    ...
    content: "Fat/Oil + NaOH(aq) → Soap (fatty acid sodium salt) + Glycerol\nExample: (RCOO)₃C₃H₅ + 3NaOH → 3RCOONa + C₃H₅(OH)₃"
  }
];
const quadraticQuestions = [
  {
    ...
    correctIndex: 0,
    explanation: "The discriminant D = b² - 4ac determines the nature of roots. D > 0: two distinct real roots; D = 0: two equal roots; D < 0: no real roots."
  },
  {
    id: 12,
    ...
    correctIndex: 2,
    explanation: "When D = b² - 4ac = 0, the quadratic formula gives x = -b/2a (only one value), meaning both roots are equal and real."
  },
  {
    id: 13,
    ...
    correctIndex: 0,
    explanation: "Factoring: x² - 5x + 6 = (x-2)(x-3) = 0. Therefore x = 2 or x = 3. Verify: sum of roots = 5 = -b/a ✓, product = 6 = c/a ✓"
  },
  {
    id: 14,
    question: "Which method cannot always be used to solve quadratic equations?",
    options: [
      "Quadratic formula",
    ...
    correctIndex: 2,
    explanation: "Factorization can only be applied when the quadratic can be expressed as a product of linear factors with rational coefficients. The quadratic formula and completing the square always work."
  },
  {
    id: 15,
    ...
    correctIndex: 1,
    explanation: "By Vieta's formulas, for ax² + bx + c = 0 with roots α and β: Sum (α + β) = -b/a, Product (α × β) = c/a."
  },
  {
    id: 16,
    ...
    options: ["2", "-2", "10", "-10"],
    correctIndex: 0,
    explanation: "Substituting x = 2: 4 - 6 + k = 0, so k = 2. Verify with Vieta's: product of roots = k/1 = 2, so other root = 2/2 = 1. Sum = 1+2 = 3 ✓"
  },
  {
    id: 17,
    ...
    correctIndex: 0,
    explanation: "Using the quadratic formula: x = (-1 ± √(1+48))/4 = (-1 ± 7)/4. So x = 6/4 = 3/2 or x = -8/4 = -2."
  },
  {
    id: 18,
    ...
    correctIndex: 2,
    explanation: "When D = b² - 4ac < 0, the square root of a negative number is not real. The equation has two complex conjugate roots (no real solutions)."
  },
  {
    id: 19,
    ...
    correctIndex: 1,
    explanation: "Sum of roots = 3 + (-4) = -1 = -b/a, so b = 1. Product = 3 × (-4) = -12 = c/a, so c = -12. Equation: x² + x - 12 = 0."
  },
  {
    id: 20,
    ...
    correctIndex: 2,
    explanation: "D = 4² - 4(1)(5) = 16 - 20 = -4 < 0. Since D < 0, the equation has no real roots (roots are complex: -2 ± i)."
  }
];
const quadraticFlashcards = [
  {
    id: 9,
...
const quadraticCheatsheet = [
  {
    id: 7,
    type: "Formula",
    icon: "⚗️",
    title: "Quadratic Formula",
    content: "x = [-b ± √(b² - 4ac)] / 2a for equation ax² + bx + c = 0 (a ≠ 0). Discriminant: D = b² - 4ac"
  },
  {
    id: 8,
    type: "Definition",
  ...
  },
  {
    ...
    content: "For roots α, β of ax² + bx + c = 0:\nSum: α + β = -b/a\nProduct: α × β = c/a\nForm equation: x² - (sum)x + (product) = 0"
  },
  {
    id: 10,
    type: "Tip",
  ...
  },
  {
    ...
    icon: "📖",
    title: "Standard Form",
    content: "ax² + bx + c = 0 where a≠0\na = coefficient of x², b = coefficient of x, c = constant term\nDegree = 2 (highest power of variable)"
  }
];
const frenchRevolutionQuestions = [
  {
    id: 21,
    question: "The French Revolution began in the year:",
    options: ["1776", "1789", "1804", "1815"],
    correctIndex: 1,
    explanation: "The French Revolution began in 1789 with the convening of the Estates-General and the storming of the Bastille on July 14, 1789 — now celebrated as Bastille Day."
  },
  {
    id: 22,
    ...
    correctIndex: 0,
    explanation: "'Liberté, Égalité, Fraternité' (Liberty, Equality, Fraternity) became the national motto of France and the guiding principle of the Revolution."
  },
  {
    id: 23,
    ...
    correctIndex: 1,
    explanation: "French society was divided into Three Estates: First Estate (Clergy), Second Estate (Nobility), Third Estate (Commoners — bourgeoisie, peasants, workers)."
  },
  {
    id: 24,
    ...
    correctIndex: 1,
    explanation: "The Bastille was a royal fortress and prison symbolizing royal despotism. Its storming on July 14, 1789 by Parisian crowds symbolized the fall of royal tyranny and the start of the Revolution."
  },
  {
    id: 25,
    question: "The Declaration of the Rights of Man and of the Citizen was adopted in:",
    options: ["1787", "1789", "1792", "1795"],
    correctIndex: 1,
    explanation: "The Declaration of the Rights of Man and of the Citizen was adopted by the National Constituent Assembly on August 26, 1789, proclaiming individual freedoms and equality before the law."
  },
  {
    id: 26,
    ...
    correctIndex: 2,
    explanation: "Robespierre, leading the Committee of Public Safety, orchestrated the Reign of Terror (1793-94) during which thousands perceived as enemies of the Revolution were executed by guillotine."
  },
  {
    id: 27,
    ...
    correctIndex: 2,
    explanation: "The bourgeoisie (educated middle class — merchants, lawyers, intellectuals) were the primary drivers of the Revolution. They opposed feudal privileges and demanded political representation and rights."
  },
  {
    id: 28,
    ...
    correctIndex: 1,
    explanation: "Napoleon seized power through the coup of 18 Brumaire (November 9, 1799), overthrowing the Directory government and establishing himself as First Consul, effectively ending the Revolution."
  },
  {
    id: 29,
    ...
    correctIndex: 2,
    explanation: "France faced severe financial bankruptcy (partly from supporting the American Revolution) and widespread food shortages causing bread prices to soar. This immediate crisis triggered the 1789 uprising."
  },
  {
    id: 30,
    ...
    correctIndex: 2,
    explanation: "Popular sovereignty — the idea that political authority derives from the people, not from divine right of kings — was a central principle of the Revolution, fundamentally changing political theory."
  }
];
...
const frenchCheatsheet = [
  {
    id: 13,
    type: "Definition",
    icon: "📖",
    title: "The Three Estates",
    content: "First Estate: Clergy | Second Estate: Nobility | Third Estate: Commoners (97% of population). First two estates had tax exemptions, Third Estate bore all tax burden."
  },
  {
    id: 14,
    type: "Formula",
  ...
  },
  {
    ...
    content: "Political authority derives from the consent of the people (not divine right of kings). Key concept introduced by Rousseau's Social Contract and central to the Revolution."
  },
  {
    id: 16,
    type: "Tip",
  ...
  },
  {
    ...
    content: "Third Estate locked out of Estates-General meeting. Members gathered at a nearby tennis court and swore to remain until a constitution was written. Directly challenged royal authority."
  },
  {
    id: 18,
    type: "Definition",
    ...
    content: "Jacobins: radical republicans led by Robespierre, believed in centralized government and Terror. Girondins: moderate republicans, favored federalism. Jacobins eliminated Girondins in 1793 during radicalization."
  }
];
const topicsData = [
  {
    ...
    questionCount: 10,
    difficulty: "Medium",
    description: "Explore organic chemistry fundamentals including IUPAC naming, functional groups, and key reactions like esterification and saponification.",
  ...
  },
  {
    ...
    questionCount: 10,
    difficulty: "Medium",
    description: "Master quadratic equations using discriminant analysis, Vieta's formulas, and multiple solving methods including factorization and completing the square.",
  ...
  },
  {
    ...
    questionCount: 10,
    difficulty: "Easy",
    description: "Understand the causes, key events, and lasting impact of the French Revolution on world history, from the Estates-General to Napoleon's rise.",
