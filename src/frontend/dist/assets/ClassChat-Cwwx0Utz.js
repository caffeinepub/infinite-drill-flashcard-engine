import { c as createLucideIcon, u as useParams, s as useAuth, h as useActor, r as reactExports, j as jsxRuntimeExports, L as Link, a as cn, A as AnimatePresence, d as Button, I as Input, f as ue, m as motion } from "./index-d1c5XO2W.js";
import { S as ScrollArea } from "./scroll-area-hX2pirAF.js";
import { S as Skeleton, T as Trash2 } from "./skeleton-CuxegdPS.js";
import { u as useAdminRole, N as NavBar, M as MessageCircle } from "./NavBar-BR_djSqx.js";
import { A as ArrowLeft } from "./arrow-left-WqYIVh5n.js";
import { S as Send } from "./send-CTAAiUlg.js";
...
const roomDescriptions = {
  "class-1": "a space for Class 1 students to discuss numbers, alphabets, shapes, and EVS topics with each other.",
  "class-2": "a community for Class 2 students to share notes on rhymes, basic maths, and general knowledge.",
  "class-3": "a chat room for Class 3 students covering Maths, EVS, and language basics from the NCERT syllabus.",
  "class-4": "a live study room for Class 4 students to discuss fractions, science experiments, and social studies.",
  "class-5": "a community room for Class 5 students working through EVS, Maths, and grammar fundamentals.",
  "class-6": "a live chat for Class 6 CBSE students covering History, Science, and Algebra basics from NCERT textbooks.",
  "class-7": "a study community for Class 7 students discussing Geography, Biology, Decimals, and NCERT exercises.",
  "class-8": "a chat room for Class 8 CBSE students covering Civics, Physics basics, Linear Equations, and more.",
  "class-9": "a live study room for Class 9 students discussing Coordinate Geometry, Laws of Motion, and board prep.",
  "class-10": "a board exam preparation community for Class 10 CBSE students covering Science, Maths, Social Science, English, and Hindi.",
  "class-11": "a community for Class 11 students diving deep into Physics, Chemistry, Mathematics, and Biology.",
  "class-12": "a board and entrance exam strategy room for Class 12 CBSE students preparing for finals and competitive exams.",
  "iit-jee": "an advanced study community for IIT JEE aspirants tackling Physics, Chemistry, and Mathematics at JEE Main and Advanced level."
};
...
function ClassChat() {
  ...
  const roomDesc = roomDescriptions[roomId] ?? `a live study community for ${roomLabel} students.`;
  const { user } = useAuth();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background flex flex-col", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-3xl mx-auto w-full px-4 pb-8 mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-dark rounded-2xl p-5 border border-border/40", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-base font-bold mb-2 text-foreground", children: [
        roomLabel,
        " Chat Room — Free CBSE Study Community"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground leading-relaxed", children: [
        "This is ",
        roomDesc,
        " Share your doubts, upload photos of textbook pages, post audio notes, and get help from peers who are studying the same NCERT curriculum. NCERT Bhaiya's community chat is completely free and available 24/7 — just sign in and start a conversation. Combine this chat with the",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "text-primary hover:underline", children: "quizzes, flashcards, and cheat sheets" }),
        " ",
