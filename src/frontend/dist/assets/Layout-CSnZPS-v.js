const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/AITeacher-CWuRT8Kq.js","assets/index-D_F9JBVH.js","assets/index-BlkGGmCs.css","assets/scroll-area-DrELWyYR.js","assets/x-k8D_yfuw.js","assets/send-CSrAJLEI.js"])))=>i.map(i=>d[i]);
import { j as jsxRuntimeExports, L as Link, r as reactExports, _ as __vitePreload } from "./index-D_F9JBVH.js";
import { N as NavBar } from "./NavBar-BiasoI0O.js";
const AITeacher = reactExports.lazy(
  () => __vitePreload(() => import("./AITeacher-CWuRT8Kq.js"), true ? __vite__mapDeps([0,1,2,3,4,5]) : void 0).then((m) => ({ default: m.AITeacher }))
);
