const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/AITeacher-D3WjqlkO.js","assets/index-BHGjSnc4.js","assets/index-BlkGGmCs.css","assets/scroll-area-Cc1VnOBE.js","assets/x-CVPNfDW7.js","assets/send-DLQ3wXNL.js"])))=>i.map(i=>d[i]);
import { j as jsxRuntimeExports, L as Link, r as reactExports, _ as __vitePreload } from "./index-BHGjSnc4.js";
import { N as NavBar } from "./NavBar-CrndQtSg.js";
const AITeacher = reactExports.lazy(
  () => __vitePreload(() => import("./AITeacher-D3WjqlkO.js"), true ? __vite__mapDeps([0,1,2,3,4,5]) : void 0).then((m) => ({ default: m.AITeacher }))
);
