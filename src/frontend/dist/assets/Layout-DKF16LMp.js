const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/AITeacher-DTvICkGB.js","assets/index-CCl8XRyv.js","assets/index-Bs8Uw2wJ.css","assets/scroll-area-Dz_xI3Zr.js","assets/x-CDY8v4iw.js","assets/send-CtYSLJq7.js"])))=>i.map(i=>d[i]);
import { j as jsxRuntimeExports, L as Link, r as reactExports, _ as __vitePreload } from "./index-CCl8XRyv.js";
import { N as NavBar } from "./NavBar-D-mOAbCg.js";
const AITeacher = reactExports.lazy(
  () => __vitePreload(() => import("./AITeacher-DTvICkGB.js"), true ? __vite__mapDeps([0,1,2,3,4,5]) : void 0).then((m) => ({ default: m.AITeacher }))
);
