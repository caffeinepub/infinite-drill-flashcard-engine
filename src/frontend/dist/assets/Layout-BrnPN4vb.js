const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/AITeacher-O5Qm0gyV.js","assets/index-DLyQvIg0.js","assets/index-BlkGGmCs.css","assets/scroll-area-B8BsgO6O.js","assets/x-EvyhuLAk.js","assets/send-C7lmVbqr.js"])))=>i.map(i=>d[i]);
import { j as jsxRuntimeExports, L as Link, r as reactExports, _ as __vitePreload } from "./index-DLyQvIg0.js";
import { N as NavBar } from "./NavBar-Db-ZsZ9A.js";
const AITeacher = reactExports.lazy(
  () => __vitePreload(() => import("./AITeacher-O5Qm0gyV.js"), true ? __vite__mapDeps([0,1,2,3,4,5]) : void 0).then((m) => ({ default: m.AITeacher }))
);
