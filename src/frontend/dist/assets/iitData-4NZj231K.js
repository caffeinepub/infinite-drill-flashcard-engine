      ...
      topics: [
        {
          id: "phy-kinematics",
          name: "Kinematics",
          description: "Study of motion without considering its cause. Covers displacement, velocity, acceleration, and equations of motion for uniform and non-uniform motion in 1D, 2D, and 3D.",
          keyConcepts: [
            {
              title: "Equations of Motion",
              description: "v = u + at, s = ut + ½at², v² = u² + 2as for uniform acceleration"
            },
            {
              title: "Projectile Motion",
              description: "Combination of horizontal uniform motion and vertical uniformly accelerated motion"
            },
            {
              title: "Relative Motion",
              description: "Motion of one object with respect to another; river-boat and rain-man problems"
            },
            {
              title: "Circular Motion",
              description: "Centripetal acceleration a = v²/r = ω²r for uniform circular motion"
            }
          ],
          importantFormulas: [
        ...
        },
        {
          id: "phy-laws-motion",
          name: "Laws of Motion",
          description: "Newton's three laws of motion form the foundation of classical mechanics. Covers free body diagrams, friction, tension, and pseudo forces in non-inertial frames.",
          keyConcepts: [
            {
              title: "Newton's First Law",
              description: "A body remains at rest or in uniform motion unless acted upon by an external net force (Inertia)"
            },
            {
              title: "Newton's Second Law",
              description: "Net force equals rate of change of momentum: F = ma"
            },
            {
            ...
            {
              title: "Friction",
              description: "Static friction fs ≤ μsN; Kinetic friction fk = μkN"
            }
          ],
          importantFormulas: [
        ...
        },
        {
          ...
          description: "Energy conservation, work-energy theorem, and power. Covers potential energy, kinetic energy, elastic and inelastic collisions.",
          keyConcepts: [
            {
              title: "Work-Energy Theorem",
              description: "Net work done on a body equals change in its kinetic energy"
            },
            {
              title: "Conservation of Energy",
              description: "Total mechanical energy remains constant in absence of non-conservative forces"
            },
            {
        ...
        },
        {
          ...
          description: "Angular kinematics, torque, moment of inertia, angular momentum. Covers rolling motion and parallel axis theorem.",
          keyConcepts: [
            {
              title: "Torque",
        ...
        },
        {
          id: "phy-gravitation",
          name: "Gravitation",
          description: "Newton's law of gravitation, gravitational potential, orbital motion of satellites, Kepler's laws, and escape velocity.",
          keyConcepts: [
            {
              title: "Newton's Law of Gravitation",
              description: "F = GMm/r² — gravitational force between two masses"
            },
            {
              title: "Kepler's Laws",
              description: "Elliptical orbits, equal areas in equal times, T² ∝ r³"
            },
            {
              title: "Escape Velocity",
              description: "Minimum velocity to escape Earth's gravitational field"
            },
            {
              title: "Orbital Velocity",
              description: "Velocity required for a satellite to orbit at a given height"
            }
          ],
          importantFormulas: [
      ...
      topics: [
        {
          ...
          description: "Heat, temperature, thermal expansion, calorimetry, and heat transfer by conduction, convection, and radiation.",
          keyConcepts: [
            {
              title: "Thermal Expansion",
              description: "Solids, liquids, and gases expand on heating; coefficient of linear, area, and volume expansion"
            },
            {
              title: "Calorimetry",
              description: "Heat gained = Heat lost; specific heat capacity Q = mcΔT"
            },
            {
              title: "Newton's Law of Cooling",
              description: "Rate of cooling ∝ temperature difference with surroundings"
            },
            {
              title: "Heat Transfer",
              description: "Conduction, Convection, and Radiation are three modes of heat transfer"
            }
          ],
          importantFormulas: [
        ...
        },
        {
          ...
          description: "Ideal gas model, Maxwell-Boltzmann distribution, degrees of freedom, equipartition theorem, and mean free path.",
          keyConcepts: [
            {
              title: "Ideal Gas Law",
            ...
            {
              title: "RMS Speed",
              description: "Root mean square speed of gas molecules vrms = √(3RT/M)"
            },
            {
        ...
        },
        {
          ...
          description: "First and second laws of thermodynamics, internal energy, entropy, Carnot cycle, and efficiency of heat engines.",
          keyConcepts: [
            {
              title: "First Law",
            ...
            {
              title: "Second Law",
              description: "Heat cannot flow spontaneously from cold to hot body; entropy of universe increases"
            },
            {
            ...
            {
              title: "Entropy",
              description: "Measure of disorder; ΔS = Q/T for reversible process"
            }
          ],
          importantFormulas: [
      ...
      topics: [
        {
          ...
          name: "Electrostatics",
          description: "Electric charges, Coulomb's law, electric field, electric potential, capacitors, and dielectrics.",
          keyConcepts: [
            {
              title: "Coulomb's Law",
            ...
            {
              title: "Gauss's Law",
              description: "Total electric flux through a closed surface = q_enc/ε₀"
            },
            {
              title: "Capacitance",
        ...
        },
        {
          ...
          description: "Electric current, Ohm's law, resistance, Kirchhoff's laws, Wheatstone bridge, and RC circuits.",
          keyConcepts: [
            { title: "Ohm's Law", description: "V = IR; resistance R = ρL/A" },
            {
              title: "Kirchhoff's Laws",
              description: "KCL: Sum of currents at junction = 0; KVL: Sum of EMFs = Sum of IR drops in a loop"
            },
            {
              title: "Wheatstone Bridge",
              description: "Balanced condition: R₁/R₂ = R₃/R₄; used to find unknown resistance"
            },
        ...
        },
        {
          ...
          description: "Biot-Savart law, Ampere's law, magnetic force on current-carrying conductors, and electromagnetic induction.",
          keyConcepts: [
            {
              title: "Biot-Savart Law",
              description: "dB = μ₀I dl × r̂ / (4πr²); magnetic field due to current element"
            },
            {
              title: "Faraday's Law",
              description: "EMF = −dΦ/dt; induced EMF due to changing magnetic flux"
            },
            {
              title: "Lenz's Law",
      ...
      topics: [
        {
          id: "phy-ray-optics",
          name: "Ray Optics",
          description: "Reflection, refraction, lenses, mirrors, prisms, and optical instruments including microscope and telescope.",
          keyConcepts: [
            {
              title: "Snell's Law",
              description: "n₁sinθ₁ = n₂sinθ₂; describes refraction at interface"
            },
            {
            ...
            },
            {
              ...
              description: "Occurs when light travels from denser to rarer medium at angle > critical angle"
            }
          ],
          importantFormulas: [
        ...
        },
        {
          id: "phy-wave-optics",
          name: "Wave Optics",
          description: "Wave nature of light, Huygens' principle, interference, diffraction, and polarisation.",
          keyConcepts: [
            {
            ...
            {
              title: "Diffraction",
              description: "Bending of light around obstacles; single slit minima at a sinθ = nλ"
            },
            {
              title: "Polarisation",
              description: "Malus' law: I = I₀cos²θ; transverse nature of light"
            },
            {
              title: "Huygens' Principle",
              description: "Each point on a wavefront acts as source of secondary wavelets"
            }
          ],
          importantFormulas: [
      ...
      topics: [
        {
          ...
          description: "Wave-particle duality, photoelectric effect, de Broglie wavelength, and Compton scattering.",
          keyConcepts: [
            {
              title: "Photoelectric Effect",
              description: "KE_max = hν − φ (work function); no electrons below threshold frequency"
            },
            {
              title: "de Broglie Hypothesis",
              description: "Every particle has associated wavelength λ = h/p = h/mv"
            },
            {
              title: "Photon",
            ...
            },
            {
              ...
              description: "Scattering of X-rays by electrons proves particle nature of photons"
            }
          ],
          importantFormulas: [
        ...
        },
        {
          ...
          description: "Bohr's model of hydrogen atom, nuclear structure, radioactivity, nuclear reactions, and binding energy.",
          keyConcepts: [
            {
              title: "Bohr's Model",
              description: "Electrons orbit in fixed shells; energy En = −13.6/n² eV for hydrogen"
            },
            {
              title: "Radioactivity",
              description: "Alpha (α), Beta (β), and Gamma (γ) decay; half-life T½ = 0.693/λ"
            },
            {
              title: "Binding Energy",
              description: "BE = (Δm)c²; mass defect Δm = Zm_p + Nm_n − M_nucleus"
            },
            {
              title: "Nuclear Fission/Fusion",
              description: "Fission: heavy nucleus splits; Fusion: light nuclei combine; both release energy"
            }
          ],
          importantFormulas: [
        ...
        },
        {
          ...
          description: "Energy bands, semiconductors, p-n junction, diodes, transistors, and logic gates.",
          keyConcepts: [
            {
              title: "Energy Bands",
              description: "Valence band, conduction band, and forbidden energy gap determine conductivity"
            },
            {
              title: "p-n Junction",
              description: "Depletion region formed; forward bias reduces, reverse bias increases barrier"
            },
            {
              title: "Transistor",
              description: "NPN/PNP transistor as amplifier and switch; α and β current gain"
            },
            {
              title: "Logic Gates",
      ...
      topics: [
        {
          ...
          description: "Oscillatory motion, restoring force, time period, energy in SHM, and spring-mass systems.",
          keyConcepts: [
            {
            ...
            {
              title: "Phase",
              description: "x = A sin(ωt + φ); displacement as sinusoidal function of time"
            }
          ],
          importantFormulas: [
        ...
        },
        {
          id: "phy-waves",
          name: "Waves",
          description: "Transverse and longitudinal waves, speed of sound, superposition principle, standing waves, Doppler effect.",
          keyConcepts: [
            {
              title: "Wave Equation",
            ...
            },
            {
              ...
              description: "Formed by superposition of two identical waves travelling in opposite directions"
            },
            {
              title: "Doppler Effect",
              description: "Apparent change in frequency due to relative motion between source and observer"
            }
          ],
          importantFormulas: [
      ...
      topics: [
        {
          ...
          description: "Mole, Avogadro's number, molar mass, empirical and molecular formulas, limiting reagent, and percentage yield.",
          keyConcepts: [
            {
              title: "Mole",
            ...
            {
              title: "Molar Mass",
              description: "Mass of 1 mole in grams; numerically equal to molecular weight"
            },
            {
              title: "Limiting Reagent",
              description: "Reactant that gets consumed first and limits the amount of product formed"
            },
            {
        ...
        },
        {
          ...
          description: "Bohr model, quantum numbers, electronic configuration, orbitals, and Aufbau principle.",
          keyConcepts: [
            {
              title: "Quantum Numbers",
              description: "n (principal), l (azimuthal), ml (magnetic), ms (spin) define each electron's state"
            },
            {
              title: "Aufbau Principle",
              description: "Electrons fill orbitals in order of increasing energy"
            },
            {
              title: "Hund's Rule",
              description: "Electrons occupy separate orbitals with parallel spins before pairing"
            },
            {
              title: "Pauli Exclusion Principle",
              description: "No two electrons can have identical set of all four quantum numbers"
            }
          ],
          importantFormulas: [
        ...
        },
        {
          ...
          description: "Equilibrium constant, Le Chatelier's principle, ionic equilibrium, pH, buffers, and solubility product.",
          keyConcepts: [
            {
              title: "Equilibrium Constant",
              description: "Kc = [products]^coeff / [reactants]^coeff; Kp = Kc(RT)^Δn"
            },
            {
              title: "Le Chatelier's Principle",
              description: "System at equilibrium shifts to oppose any change imposed on it"
            },
            {
              title: "pH Scale",
        ...
        },
        {
          ...
          description: "Enthalpy, entropy, Gibbs free energy, Hess's law, and spontaneity of reactions.",
          keyConcepts: [
            {
              title: "Enthalpy",
            ...
            {
              title: "Hess's Law",
              description: "Enthalpy change is independent of path; ΔH = ΣΔHf(products) − ΣΔHf(reactants)"
            },
            {
            ...
            {
              title: "Bond Enthalpy",
              description: "Energy required to break 1 mole of bonds in gaseous state"
            }
          ],
          importantFormulas: [
        ...
        },
        {
          ...
          description: "Electrolytic cells, galvanic cells, EMF, Nernst equation, conductance, and Faraday's laws.",
          keyConcepts: [
            {
              title: "Nernst Equation",
              description: "E = E° − (RT/nF)ln Q; cell potential depends on concentration"
            },
            {
              title: "Faraday's Laws",
              description: "Mass deposited proportional to charge; equivalent mass determines relative deposition"
            },
            {
              title: "Kohlrausch's Law",
              description: "Limiting molar conductivity = sum of individual ionic conductivities"
            },
            {
              title: "Standard Electrode Potential",
              description: "Measured against standard hydrogen electrode (SHE = 0 V)"
            }
          ],
          importantFormulas: [
      ...
      topics: [
        {
          ...
          description: "Periodic trends in atomic radius, ionization energy, electron affinity, electronegativity, and oxidation states.",
          keyConcepts: [
            {
              title: "Atomic Radius",
              description: "Decreases across period (nuclear charge increases); increases down group (new shell added)"
            },
            {
              title: "Ionization Energy",
              description: "Energy to remove electron; increases across period, decreases down group"
            },
            {
              title: "Electron Affinity",
              description: "Energy released when electron added; halogens have highest EA"
            },
            {
              title: "Electronegativity",
              description: "Fluorine most electronegative; used to predict bond polarity"
            }
          ],
          importantFormulas: [
            {
        ...
        },
        {
          ...
          description: "Werner's theory, IUPAC nomenclature, isomerism in coordination compounds, and crystal field theory.",
          keyConcepts: [
            {
              title: "Coordination Number",
              description: "Number of ligands directly bonded to central metal atom"
            },
            {
              title: "Crystal Field Theory",
              description: "Splitting of d orbitals in crystal field; Δo for octahedral, Δt for tetrahedral"
            },
            {
              title: "IUPAC Nomenclature",
              description: "Ligands named first alphabetically, then metal with oxidation state in brackets"
            },
            {
              title: "Isomerism",
              description: "Geometric (cis/trans), optical, linkage, ionisation, and coordination isomers"
            }
          ],
          importantFormulas: [
            {
        ...
        },
        {
          ...
          description: "Properties, reactions, and compounds of alkali metals, alkaline earth metals, and p-block elements (Groups 13–18).",
          keyConcepts: [
            {
              title: "Alkali Metals",
              description: "Group 1; very reactive, form +1 ions; Li most electronegative, Cs most reactive"
            },
            {
              title: "Alkaline Earth Metals",
              description: "Group 2; form +2 ions; Mg and Be anomalous behaviour"
            },
            {
              title: "p-Block Trends",
              description: "Inert pair effect; oxidation states, hydrides, oxides, halides across groups"
            },
            {
              title: "Noble Gases",
              description: "Group 18; almost chemically inert; Xe forms compounds with F and O"
            }
          ],
          importantFormulas: [
            {
              name: "Flame test colours",
              formula: "Li-red, Na-yellow, K-violet, Cs-blue, Ba-green, Sr-crimson"
            },
            {
            ...
            },
            {
              ...
              formula: "Increases down Group 2: Be(OH)₂ < Mg(OH)₂ < ... < Ba(OH)₂"
            }
          ],
        ...
        },
        {
          ...
          description: "Transition metals, variable oxidation states, catalytic properties, coloured compounds, and lanthanides/actinides.",
          keyConcepts: [
            {
              title: "Variable Oxidation States",
              description: "Due to small energy difference between (n-1)d and ns orbitals"
            },
            {
              title: "Coloured Compounds",
              description: "Due to d-d transitions in partially filled d orbitals"
            },
            {
              title: "Catalytic Properties",
              description: "Transition metals act as catalysts due to variable valency and surface area"
            },
            {
              title: "Lanthanide Contraction",
              description: "Steady decrease in ionic radii across lanthanides due to poor f-orbital shielding"
            }
          ],
          importantFormulas: [
            {
      ...
      topics: [
        {
          ...
          description: "Hybridization, IUPAC nomenclature, isomerism, inductive/mesomeric effects, and reactive intermediates.",
          keyConcepts: [
            {
              title: "Hybridization",
              description: "sp³ (tetrahedral), sp² (trigonal planar), sp (linear) carbon"
            },
            {
              title: "Inductive Effect",
              description: "Electron withdrawal/donation through σ bonds; -I and +I groups"
            },
            {
              title: "Resonance",
              description: "Delocalization of π electrons; actual structure is hybrid of all resonance forms"
            },
            {
              title: "Reactive Intermediates",
              description: "Carbocation (sp²), Carbanion (sp³), Radical (sp²), Carbene"
            }
          ],
          importantFormulas: [
            {
            ...
            },
            {
              ...
              formula: "Priority by atomic number; clockwise = R, anticlockwise = S"
            },
            {
              name: "E/Z isomerism",
              formula: "E = opposite sides (entgegen); Z = same side (zusammen)"
            },
            {
        ...
        },
        {
          ...
          name: "Hydrocarbons",
          description: "Alkanes (substitution), alkenes (addition), alkynes (addition), and aromatic compounds (electrophilic substitution).",
          keyConcepts: [
            {
              title: "Alkane Reactions",
              description: "Free radical halogenation; reactivity of tertiary > secondary > primary H"
            },
            {
              title: "Alkene Reactions",
              description: "Electrophilic addition; Markovnikov's rule; anti-Markovnikov (peroxide)"
            },
            {
              title: "Benzene Reactions",
              description: "Electrophilic aromatic substitution: nitration, halogenation, sulfonation, Friedel-Crafts"
            },
            {
              title: "Aromatic Stability",
              description: "Benzene is stabilized by resonance energy of ~150 kJ/mol"
            }
          ],
          importantFormulas: [
            {
              name: "Markovnikov's rule",
              formula: "H adds to carbon with more H (positive charge on more substituted C)"
            },
            {
              name: "Peroxide effect",
              formula: "Anti-Markovnikov addition in presence of peroxide (free radical mechanism)"
            },
            {
            ...
            {
              name: "Hückel rule",
              formula: "Aromatic if (4n + 2) π electrons in planar cyclic conjugated system"
            }
          ],
        ...
        },
        {
          ...
          description: "Alcohols, aldehydes, ketones, carboxylic acids, amines, and their reactions. Named reactions in organic chemistry.",
          keyConcepts: [
            {
              title: "Nucleophilic Addition",
              description: "Characteristic of carbonyl compounds; Nu attacks electrophilic carbon"
            },
            {
              title: "Acidity Order",
              description: "Carboxylic acids > Phenols > Alcohols > Alkynes > Water > Alkenes > Alkanes"
            },
            {
              title: "Aldol Condensation",
              description: "β-hydroxy carbonyl compound formed; requires α-hydrogen"
            },
            {
              title: "Cannizzaro Reaction",
              description: "Disproportionation of aldehydes without α-H; one reduced, one oxidised"
            }
          ],
          importantFormulas: [
            {
              name: "Lucas test",
              formula: "3° alcohol reacts immediately; 1° doesn't react without heat"
            },
            {
              name: "Iodoform test",
        ...
        },
        {
          ...
          description: "Classification of polymers, addition and condensation polymerisation, carbohydrates, proteins, nucleic acids, and vitamins.",
          keyConcepts: [
            {
              title: "Addition Polymers",
              description: "Formed from monomers with double bonds; no by-product; PVC, polyethylene"
            },
            {
              title: "Condensation Polymers",
              description: "Formed with loss of small molecule; nylon, dacron, bakelite"
            },
            {
              title: "Carbohydrates",
              description: "Monosaccharides (glucose, fructose), disaccharides (sucrose, maltose), polysaccharides (starch, cellulose)"
            },
            {
              title: "Proteins",
              description: "Polymers of amino acids linked by peptide bonds; primary to quaternary structure"
            }
          ],
          importantFormulas: [
            {
            ...
            {
              name: "DNA bases",
              formula: "Purines: Adenine, Guanine; Pyrimidines: Thymine, Cytosine"
            }
          ],
...
const mathSubject = {
  ...
  icon: "📐",
  color: "neon-purple",
  description: "Algebra, Calculus, Coordinate Geometry, Trigonometry, Vectors & 3D",
  units: [
    {
      id: "math-unit-1",
      number: 1,
      ...
      topics: [
        {
          ...
          description: "Roots of quadratic equations, Vieta's formulas, nature of roots, common roots, and higher degree polynomials.",
          keyConcepts: [
            {
            ...
            },
            {
              ...
              description: "Discriminant D = b²−4ac: D>0 real distinct, D=0 real equal, D<0 complex"
            },
            {
              title: "Symmetric Functions",
              description: "Expressions involving roots that don't change when roots are interchanged"
            },
            {
              title: "Transformation of Roots",
              description: "If α,β are roots of f(x), find equations with roots f(α), f(β)"
            }
          ],
          importantFormulas: [
        ...
        },
        {
          ...
          description: "Arithmetic progression, geometric progression, harmonic progression, AGM inequality, and sum of special series.",
          keyConcepts: [
            {
              title: "AP",
              description: "Common difference d = aₙ − aₙ₋₁; nth term = a + (n−1)d; Sₙ = n/2(2a + (n−1)d)"
            },
            {
              title: "GP",
              description: "Common ratio r = aₙ/aₙ₋₁; nth term = arⁿ⁻¹; Sₙ = a(rⁿ−1)/(r−1)"
            },
            {
            ...
            },
            {
              ...
              description: "Σn = n(n+1)/2; Σn² = n(n+1)(2n+1)/6; Σn³ = [n(n+1)/2]²"
            }
          ],
          importantFormulas: [
        ...
        },
        {
          ...
          description: "Argand plane, modulus and argument, polar form, De Moivre's theorem, and roots of unity.",
          keyConcepts: [
            {
              title: "Polar Form",
              description: "z = r(cosθ + i sinθ) = re^(iθ); r = |z|, θ = arg(z)"
            },
            {
            ...
            },
            {
              ...
              description: "n equally spaced points on unit circle; ωᵏ = e^(2πik/n)"
            },
            {
        ...
        },
        {
          ...
          description: "Types of matrices, matrix operations, determinants, inverse, Cramer's rule, and rank of a matrix.",
          keyConcepts: [
            {
              title: "Determinant Properties",
              description: "det(AB) = det(A)det(B); det(Aᵀ) = det(A); det(kA) = kⁿdet(A)"
            },
            {
        ...
        },
        {
          ...
          description: "Fundamental counting principle, factorial, permutations, combinations, binomial theorem, and multinomial theorem.",
          keyConcepts: [
            {
              title: "Permutation",
              description: "nPr = n!/(n−r)!; arrangement of r items from n distinct items"
            },
            {
              title: "Combination",
              description: "nCr = n!/r!(n−r)!; selection of r items from n; nCr = nCn-r"
            },
            {
              title: "Binomial Theorem",
              description: "(x+y)ⁿ = ΣnCr xⁿ⁻ʳ yʳ; general term Tr+1 = nCr xⁿ⁻ʳ yʳ"
            },
            {
              title: "Pigeonhole Principle",
              description: "If n items in m containers with n>m, at least one container has >1 item"
            }
          ],
          importantFormulas: [
      ...
      topics: [
        {
          ...
          description: "Definition of limits, indeterminate forms, L'Hôpital's rule, continuity, and differentiability conditions.",
          keyConcepts: [
            {
              title: "L'Hôpital's Rule",
              description: "For 0/0 or ∞/∞ form: lim f(x)/g(x) = lim f'(x)/g'(x)"
            },
            {
              title: "Standard Limits",
              description: "lim(sinx/x) = 1; lim((1+1/n)ⁿ) = e; lim((aˣ−1)/x) = ln a"
            },
            {
              title: "Continuity",
              description: "f is continuous at a if lim f(x) = f(a); left limit = right limit = value"
            },
            {
              title: "Differentiability",
              description: "Differentiable implies continuous; converse not always true"
            }
          ],
          importantFormulas: [
            {
        ...
        },
        {
          ...
          description: "Derivatives of standard functions, chain rule, implicit differentiation, parametric differentiation, and higher-order derivatives.",
          keyConcepts: [
            {
              title: "Chain Rule",
            ...
            },
            {
              ...
              description: "If f(a)=f(b) and f continuous on [a,b], there exists c where f'(c)=0"
            }
          ],
          importantFormulas: [
        ...
        },
        {
          id: "math-integration",
          name: "Integration",
          description: "Standard integrals, integration by parts, partial fractions, definite integrals, and applications (area, volume).",
          keyConcepts: [
            {
        ...
        },
        {
          ...
          description: "Order and degree, variable separable, homogeneous, linear first-order, and Bernoulli's equations.",
          keyConcepts: [
            {
            ...
            },
            {
              ...
              description: "dy/dx + P(x)y = Q(x)yⁿ; reduce by substitution v = y^(1−n)"
            }
          ],
          importantFormulas: [
      ...
      topics: [
        {
          ...
          name: "Straight Lines",
          description: "Various forms of line equations, angle between lines, distance formulas, family of lines, and locus problems.",
          keyConcepts: [
            {
            ...
            {
              title: "Normal Form",
              description: "x cosα + y sinα = p; p = perpendicular distance from origin"
            },
            {
        ...
        },
        {
          id: "math-circles",
          name: "Circles",
          description: "Equation of circle, tangent and normal, chord of contact, family of circles, and radical axis.",
          keyConcepts: [
            {
            ...
            },
            {
              ...
              description: "Length of tangent = √(S₁) where S₁ = x₁² + y₁² + 2gx₁ + 2fy₁ + c"
            },
            {
            ...
            {
              title: "Radical Axis",
              description: "Locus of point with equal tangent lengths to two circles: S₁ − S₂ = 0"
            }
          ],
          importantFormulas: [
            {
              name: "General form",
              formula: "x² + y² + 2gx + 2fy + c = 0; centre (−g,−f), r = √(g²+f²−c)"
            },
            {
        ...
        },
        {
          id: "math-conics",
          name: "Conic Sections",
          description: "Parabola, ellipse, and hyperbola — equations, eccentricity, foci, directrix, tangents, normals, and reflective properties.",
          keyConcepts: [
            {
              title: "Parabola",
              description: "y² = 4ax; focus (a,0), directrix x = −a, eccentricity e = 1"
            },
            {
              title: "Ellipse",
              description: "x²/a² + y²/b² = 1 (a>b); e = c/a < 1; b² = a²(1−e²)"
            },
            {
              title: "Hyperbola",
            ...
            {
              title: "Focal Chord",
              description: "Chord passing through focus; semi-latus rectum = b²/a"
            }
          ],
          importantFormulas: [
            {
        ...
        },
        {
          ...
          description: "Direction cosines, lines and planes in 3D, dot product, cross product, and applications.",
          keyConcepts: [
            {
      ...
      topics: [
        {
          ...
          description: "Basic trig ratios, identities, graphs, transformations, and values of standard angles.",
          keyConcepts: [
            {
              title: "Pythagorean Identities",
              description: "sin²θ + cos²θ = 1; 1 + tan²θ = sec²θ; 1 + cot²θ = cosec²θ"
            },
            {
              title: "Compound Angles",
              description: "sin(A±B) = sinA cosB ± cosA sinB; cos(A±B) = cosA cosB ∓ sinA sinB"
            },
            {
              title: "Double Angle",
              description: "sin2A = 2sinAcosA; cos2A = cos²A − sin²A = 2cos²A − 1"
            },
            {
        ...
        },
        {
          ...
          description: "Domain and range of inverse trig functions, principal values, and properties.",
          keyConcepts: [
            {
              title: "Principal Values",
              description: "sin⁻¹ range [−π/2, π/2]; cos⁻¹ range [0,π]; tan⁻¹ range (−π/2, π/2)"
            },
            {
      ...
      topics: [
        {
          id: "math-probability",
          name: "Probability",
          description: "Classical probability, conditional probability, Bayes' theorem, random variables, binomial and Poisson distributions.",
          keyConcepts: [
            {
              title: "Conditional Probability",
              description: "P(A|B) = P(A∩B)/P(B); probability of A given B has occurred"
            },
            {
              title: "Bayes' Theorem",
