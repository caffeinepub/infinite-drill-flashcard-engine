import { c as createLucideIcon, r as reactExports, l as useLayoutEffect2, n as useComposedRefs, o as useControllableState, j as jsxRuntimeExports, p as createContextScope, P as Primitive, q as composeEventHandlers, a as cn, s as useAuth, t as LoaderCircle, d as Button, T as Tabs, v as TabsList, w as TabsTrigger, x as TabsContent, h as useActor, k as useQueryClient, y as Label, I as Input, i as useQuery, S as Sparkles, B as BookOpen, E as EyeOff, z as Eye, f as ue } from "./index-d1c5XO2W.js";
import { B as Badge } from "./badge-CoXMLQ5T.js";
import { C as Card, a as CardHeader, b as CardTitle, c as CardContent } from "./card-DPD_Y4Gm.js";
import { S as Skeleton, T as Trash2 } from "./skeleton-CuxegdPS.js";
import { T as Textarea } from "./textarea-Ex40evRx.js";
import { u as useMutation } from "./useMutation-dIl4ArWl.js";
import { L as Layout } from "./Layout-D06Zi2OP.js";
import { u as useAdminRole, S as Shield, Z as Zap } from "./NavBar-BR_djSqx.js";
import { u as useSEO } from "./useSEO-BR8ss8iB.js";
import { C as Crown } from "./crown-BBY5j_qr.js";
import { U as Users } from "./users-CK84YjFT.js";
import { L as Lightbulb } from "./lightbulb-C3z9t69h.js";
import { F as FileText } from "./file-text-DCHRWVT3.js";
import { C as Calendar } from "./calendar-DYgRu9pw.js";
import "./house-C6TrkpQC.js";
import "./flask-conical-Cj5Ksvm1.js";
import "./trophy-BpnCgrVj.js";
import "./circle-user-DE7FXtp2.js";
/**
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-xl border border-border/40 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { "data-ocid": "users.table", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: users.map((u, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        TableRow,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "font-medium text-sm", children: u.fullName || "—" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(TableCell, { className: "font-mono text-xs text-muted-foreground", children: [
              "@",
              u.username
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-xs text-muted-foreground hidden md:table-cell", children: u.email || "—" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(RoleBadge, { role: u.role }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-right", children: u.username === currentUsername ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground italic", children: "(you)" }) : u.role === "admin" ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground italic", children: "Protected" }) : u.role === "operator" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                size: "sm",
                variant: "outline",
...
function SettingsTab() {
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "settings.loading_state", className: "space-y-4", children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-semibold text-foreground mb-1", children: "Site Settings" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Manage global site configuration." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border border-border/30 bg-card/20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-sm font-semibold text-foreground flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Settings, { size: 14, className: "text-blue-400" }),
        " Featured Message"
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Shown prominently on the homepage hero section." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Textarea,
          {
            value: featuredMessage || (settings == null ? void 0 : settings.featuredMessage) || "",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            ...
            onClick: () => updateSettings.mutate({
              announcement: (settings == null ? void 0 : settings.announcement) ?? "",
              announcementEnabled: (settings == null ? void 0 : settings.announcementEnabled) ?? false,
              featuredMessage: featuredMessage || (settings == null ? void 0 : settings.featuredMessage) || ""
            }),
            disabled: updateSettings.isPending,
            children: [
              updateSettings.isPending ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { size: 13, className: "animate-spin mr-1" }) : null,
              "Save Settings"
            ]
          }
        )
...
function AnnouncementsTab() {
  ...
  const { data: settings, isLoading } = useQuery({
    ...
    queryFn: async () => {
      if (!actor) return null;
      return asAdmin(actor).getSiteSettings();
    },
    enabled: !!actor,
    staleTime: 0
  });
  ...
  const updateAnnouncement = useMutation({
    mutationFn: async () => {
      ...
      return asAdmin(actor).updateSiteSettings(
        announcement || (settings == null ? void 0 : settings.announcement) || "",
        enabled,
        (settings == null ? void 0 : settings.featuredMessage) || ""
      );
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["siteSettings"] });
    ...
    onError: () => ue.error("Failed to update announcement")
  });
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-ocid": "announcements.loading_state", className: "space-y-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-12 w-full rounded-xl" }) });
  }
  const currentAnnouncement = announcement || (settings == null ? void 0 : settings.announcement) || "";
  const currentEnabled = announcement !== "" ? enabled : (settings == null ? void 0 : settings.announcementEnabled) ?? false;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-semibold text-foreground mb-1", children: "Announcements" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Post a banner message visible to all students." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border border-border/30 bg-card/20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-sm font-semibold text-foreground flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Megaphone, { size: 14, className: "text-amber-400" }),
          " Active Announcement"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: currentEnabled ? "Live" : "Off" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Switch,
            {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            ...
            children: [
              updateAnnouncement.isPending ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { size: 13, className: "animate-spin mr-1" }) : null,
              "Save Announcement"
            ]
          }
        )
...
function enhanceContentWithAI(title, description, content) {
...
In this article, we explore **${title}** — a key topic covered in NCERT curriculum. Understanding this concept thoroughly will help you score higher in CBSE exams and build a solid academic foundation.`
  ...
  for (const line of lines) {
    if (line.length < 80 && !line.endsWith(".") && sectionIdx % 5 === 0 && currentSection.length >= 3) {
  ...
  const enhancedDescription = description.trim() ? description.length < 100 ? `${description.trim()} Learn key concepts, important definitions, exam tips, and practice questions for NCERT Class students.` : description.trim() : `Complete guide to ${title} with detailed explanations, key concepts, important questions, and CBSE exam tips for NCERT students.`;
  return {
    title,
...
function BlogTab({
  ...
  const publishMutation = useMutation({
    ...
    onSuccess: () => {
      ue.success("Post published successfully!", { icon: "📝" });
      setTitle("");
      setDescription("");
      setContent("");
    ...
    onError: () => ue.error("Failed to publish post. Please try again.")
  });
  ...
  const togglePublishMutation = useMutation({
    ...
    onError: () => ue.error("Failed to update post status")
  });
  const handleEnhance = async () => {
    if (!title.trim() || !content.trim()) {
      ue.error("Please fill in Title and Content before enhancing.");
      return;
    }
    setIsEnhancing(true);
    ...
    ue.success("Content enhanced with AI!", { icon: "✨" });
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-lg font-semibold text-foreground mb-1 flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SquarePen, { size: 18, className: "text-neon-purple" }),
        "Blog Management"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Create, enhance, and publish blog posts. Posts appear publicly on the blog page." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border border-border/40 bg-card/20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-sm font-semibold text-foreground flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { size: 14, className: "text-green-400" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground", children: "This appears as the excerpt in the blog listing and as the SEO meta description." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Textarea,
            {
              id: "blog-desc",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground", children: "Write your article content. Use the AI enhance button to structure it with headings, bullet points, and a key takeaways section." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Textarea,
            {
              id: "blog-content",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 p-3 rounded-lg bg-muted/20 border border-border/30", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-7 h-7 rounded-full bg-neon-purple/20 flex items-center justify-center text-[10px] font-bold text-neon-purple", children: (currentFullName || currentUsername).charAt(0).toUpperCase() }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-medium text-foreground", children: currentFullName || currentUsername }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-2 pt-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              type: "button",
              ...
              children: [
                isEnhancing ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { size: 14, className: "animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { size: 14 }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              ...
              children: [
                publishMutation.isPending ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { size: 14, className: "animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { size: 14 }),
                publishMutation.isPending ? "Publishing..." : "Publish Post"
              ]
            }
          )
        ] }),
        !canPublish && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground", children: "All fields (Title, Description, Content) are required to publish." })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "text-sm font-semibold text-foreground flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { size: 14, className: "text-muted-foreground" }),
          "Published Posts"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "secondary", className: "text-xs", children: [
      ...
      postsLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", "data-ocid": "blog.loading_state", children: [1, 2, 3].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-16 w-full rounded-xl" }, i)) }) : !posts || posts.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { size: 32, className: "mb-2 opacity-30" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", children: "No blog posts yet." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs", children: "Create your first post above!" })
          ]
        }
      ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", "data-ocid": "blog.list", children: posts.map((post, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1 flex-wrap", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground truncate", children: post.title }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Badge,
                  {
                    className: post.published ? "bg-green-500/15 text-green-400 border-green-500/30 text-[10px]" : "bg-muted/30 text-muted-foreground border-border/30 text-[10px]",
              ...
              post.description && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground mt-1 line-clamp-1", children: post.description })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 shrink-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  ...
                  children: post.published ? /* @__PURE__ */ jsxRuntimeExports.jsx(EyeOff, { size: 13 }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Eye, { size: 13 })
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto px-4 py-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4 mb-8 p-6 rounded-2xl border border-border/30 bg-card/20 backdrop-blur-sm", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1", children: isAdmin ? "Full control — manage users, roles, settings, and blog posts." : "Content management — edit settings, announcements, and blog posts." }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: isAdmin ? "dashboard" : "blog", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        TabsList,
        {
          "data-ocid": "admin.tab",
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "blog", className: "gap-1.5 text-xs sm:text-sm", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "blog", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        BlogTab,
        {
