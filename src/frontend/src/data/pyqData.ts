// ─── PYQ Data — Class 10 CBSE Previous Year Questions ───────────────────────
...
const scienceQuestions: PYQQuestion[] = [
  {
    id: "sci-2023-1",
    year: 2023,
    question:
      "Name the type of mirror used in vehicles as rear-view mirrors. Justify your answer.",
    answer:
      "Convex mirrors are used as rear-view mirrors because they always produce an erect, diminished image giving a wider field of view of traffic behind the vehicle.",
    marks: 2,
    type: "2mark",
  },
  {
    ...
    year: 2023,
    question:
      "A student wants to project the image of a candle flame on a screen 80 cm in front of a lens by placing it at a distance of 20 cm from the lens. Which type of lens should be used?",
    answer:
      "A convex (converging) lens should be used. Using lens formula: 1/v − 1/u = 1/f. Here v = −80 cm (screen in front), u = −20 cm. 1/f = 1/(−80) − 1/(−20) = −1/80 + 1/20 = 3/80. f ≈ +26.7 cm. Positive focal length confirms a convex lens.",
    marks: 2,
    type: "2mark",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Components of the human transport system: (1) Heart — pumps blood throughout the body. (2) Blood vessels — Arteries carry oxygenated blood away from the heart; Veins carry deoxygenated blood to the heart; Capillaries exchange materials between blood and tissues. (3) Blood — transports oxygen, nutrients, hormones, and waste products. (4) Lymphatic system — returns excess tissue fluid to the bloodstream and helps in immune response.",
    marks: 5,
    type: "5mark",
  },
  {
    ...
    answer:
      "Focal length is the distance between the pole and the focus of a concave mirror.",
    marks: 1,
    type: "1mark",
  },
  {
    ...
    answer:
      "Power of a lens is the reciprocal of its focal length in metres. P = 1/f(m). It is measured in dioptres (D). A convex lens has positive power and a concave lens has negative power.",
    marks: 1,
    type: "1mark",
  },
  {
    ...
    answer:
      "When dilute hydrochloric acid is added to iron filings, iron displaces hydrogen from the acid. A displacement reaction occurs: Fe + 2HCl → FeCl₂ + H₂↑. Iron(II) chloride is formed and hydrogen gas is liberated, which burns with a pop sound.",
    marks: 2,
    type: "2mark",
  },
  {
    ...
    answer:
      "Displacement Reaction: One element displaces another element from its compound. Example: Fe + CuSO₄ → FeSO₄ + Cu. Only one exchange occurs. Double Displacement Reaction: Two compounds exchange their ions to form two new compounds. Example: Na₂SO₄ + BaCl₂ → BaSO₄↓ + 2NaCl. Both cations and anions exchange partners.",
    marks: 3,
    type: "3mark",
  },
  {
  ...
  },
  {
    ...
    year: 2022,
    question:
      "What is meant by 'biodiversity'? What will happen if biodiversity is not preserved?",
    answer:
  ...
  },
  {
    ...
    answer:
      "The epidermis in plants: (1) Provides protection against mechanical injury, pathogens and water loss. (2) In roots, it has root hair cells that increase the surface area for absorption of water and minerals. (3) In leaves, it has stomata for gaseous exchange and transpiration. (4) It is usually a single layer of cells and secretes a waxy cuticle to reduce water loss.",
    marks: 1,
    type: "1mark",
  },
  {
    ...
    answer:
      "The pancreas secretes Insulin and Glucagon. Insulin lowers blood glucose levels by stimulating cells to absorb glucose and converting excess glucose to glycogen stored in the liver. Glucagon raises blood glucose levels by breaking down glycogen back to glucose. Together, they regulate blood sugar levels.",
    marks: 2,
    type: "2mark",
  },
  {
    ...
    answer:
      "A nephron (the functional unit of the kidney) consists of: (1) Bowman's Capsule — cup-shaped structure surrounding the glomerulus. (2) Glomerulus — a network of capillaries where filtration of blood occurs. (3) Proximal Convoluted Tubule (PCT) — reabsorbs glucose, amino acids, water. (4) Loop of Henle — U-shaped tubule that concentrates the filtrate. (5) Distal Convoluted Tubule (DCT) — further reabsorption and secretion. (6) Collecting Duct — collects urine and carries it to the renal pelvis. Blood flows in from afferent arteriole and out through efferent arteriole.",
    marks: 3,
    type: "3mark",
  },
  {
    ...
    year: 2021,
    question:
      "What is Ohm's Law? State the conditions under which Ohm's Law holds good.",
    answer:
  ...
  },
  {
    ...
    answer:
      "The human brain has three main parts: (1) Cerebrum (Forebrain) — largest part; controls thinking, intelligence, memory, voluntary movements, speech, sight, hearing. Divided into left and right hemispheres. (2) Cerebellum (Hindbrain) — coordinates balance and precise voluntary movements. Responsible for muscle coordination. (3) Medulla Oblongata (Hindbrain) — controls involuntary functions like heartbeat, breathing, blood pressure, swallowing. It connects the brain to the spinal cord. Additionally, the Hypothalamus controls hunger, thirst, body temperature and links the nervous and endocrine systems. The brain is protected by the skull and three membranes (meninges) and is surrounded by cerebrospinal fluid (CSF).",
    marks: 5,
    type: "5mark",
  },
];
...
const mathsQuestions: PYQQuestion[] = [
  {
    id: "math-2023-1",
    year: 2023,
    question:
    ...
    answer:
      "Prime factorisation: 6 = 2 × 3, 72 = 2³ × 3², 120 = 2³ × 3 × 5. HCF = product of smallest powers of common factors = 2 × 3 = 6. LCM = product of greatest powers of all prime factors = 2³ × 3² × 5 = 360.",
    marks: 3,
    type: "3mark",
  },
  {
    ...
    year: 2023,
    question:
      "Find the zeroes of the polynomial x² + 7x + 10 and verify the relationship between zeroes and coefficients.",
    answer:
      "Factorising: x² + 7x + 10 = (x + 2)(x + 5). Zeroes: x = −2 and x = −5. Verification: Sum of zeroes = −2 + (−5) = −7 = −(7)/1 = −b/a ✓. Product of zeroes = (−2)(−5) = 10 = 10/1 = c/a ✓. Relationship verified.",
    marks: 3,
    type: "3mark",
  },
  {
    ...
    year: 2023,
    question:
      "Find the value of k for which the system of equations 3x − y = 5 and 6x − 2y = k has infinitely many solutions.",
    answer:
      "For infinitely many solutions: a₁/a₂ = b₁/b₂ = c₁/c₂. Here a₁/a₂ = 3/6 = 1/2, b₁/b₂ = (−1)/(−2) = 1/2, c₁/c₂ = 5/k. So 5/k = 1/2, giving k = 10.",
    marks: 2,
    type: "2mark",
  },
  {
    ...
    year: 2023,
    question:
      "If a circle is inscribed in a triangle, prove that the tangents from an external point to a circle are equal in length.",
    answer:
      "Let P be an external point and PA and PB be tangents to the circle with centre O. In triangles OAP and OBP: OA = OB (radii), OP = OP (common), ∠OAP = ∠OBP = 90° (tangent ⊥ radius). By RHS congruence: △OAP ≅ △OBP. Therefore PA = PB (CPCT). Hence proved that tangents from an external point are equal in length.",
    marks: 3,
    type: "3mark",
  },
  {
    ...
    answer:
      "Area of sector = (θ/360°) × πr². = (60/360) × π × 6². = (1/6) × π × 36 = 6π. = 6 × 22/7 ≈ 18.86 cm².",
    marks: 2,
    type: "2mark",
  },
  {
    ...
    year: 2023,
    question:
      "A bag contains 3 red and 5 black balls. A ball is drawn at random from the bag. What is the probability that the ball drawn is red?",
  ...
  },
  {
    ...
    answer:
      "tan A = 4/3 ⟹ opposite = 4, adjacent = 3, hypotenuse = √(4²+3²) = √25 = 5. sin A = 4/5, cos A = 3/5, cosec A = 5/4, sec A = 5/3, cot A = 3/4.",
    marks: 3,
    type: "3mark",
  },
  {
    ...
    answer:
      "Using factorisation: 2x² − 2x − 3x + 3 = 0, 2x(x−1) − 3(x−1) = 0, (2x−3)(x−1) = 0. x = 3/2 or x = 1.",
    marks: 2,
    type: "2mark",
  },
  {
    ...
    answer:
      "Assume √3 is rational. Then √3 = p/q, where p and q are coprime integers and q ≠ 0. Squaring: 3 = p²/q², so p² = 3q². This means 3 divides p², and since 3 is prime, 3 divides p. Let p = 3k. Then (3k)² = 3q², 9k² = 3q², 3k² = q². So 3 divides q² and hence 3 divides q. But this contradicts p and q being coprime. Hence √3 is irrational.",
    marks: 3,
    type: "3mark",
  },
  {
    ...
    answer:
      "Steps: (1) Draw a circle with radius 5 cm and centre O. (2) The angle between tangents is 60°, so the angle at centre ∠AOB = 180° − 60° = 120°. (3) Draw two radii OA and OB making angle 120° at O. (4) Draw perpendiculars at A and B to OA and OB respectively. (5) These perpendiculars meet at external point T. TA and TB are the required tangents, each tangent making 90° with the radius at the point of tangency.",
    marks: 4,
    type: "5mark",
  },
  {
    ...
    year: 2022,
    question:
      "A pole 6 m high casts a shadow 2√3 m long on the ground. Find the angle of elevation of the Sun.",
    answer:
      "tan θ = height/shadow = 6 / (2√3) = 3/√3 = √3. Therefore θ = 60°. The angle of elevation of the Sun is 60°.",
    marks: 2,
    type: "2mark",
  },
  {
    ...
    answer:
      "a = 1, d = 3, n = 20. S₂₀ = (n/2)[2a + (n−1)d] = (20/2)[2×1 + 19×3] = 10 × [2 + 57] = 10 × 59 = 590.",
    marks: 2,
    type: "2mark",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Since tangents from an external point are equal, TP = TQ. So △TPQ is isosceles, and ∠TPQ = ∠TQP. Let ∠OPQ = α. Since OP ⊥ TP (radius ⊥ tangent), ∠OPT = 90°. So ∠TPQ = 90° − α. In △TPQ: ∠PTQ + ∠TPQ + ∠TQP = 180°. ∠PTQ + 2(90° − α) = 180°. ∠PTQ = 2α = 2∠OPQ. Hence proved.",
    marks: 4,
    type: "5mark",
  },
  {
    ...
    answer:
      "Let speed = x km/h. Time = 360/x. New time = 360/(x+5). Given: 360/x − 360/(x+5) = 1. 360(x+5) − 360x = x(x+5). 1800 = x² + 5x. x² + 5x − 1800 = 0. (x+45)(x−40) = 0. x = 40 (speed cannot be negative). Speed of the train = 40 km/h.",
    marks: 4,
    type: "5mark",
  },
];
...
const sstQuestions: PYQQuestion[] = [
  {
    id: "sst-2023-1",
    year: 2023,
    question: "What is the meaning of 'print capitalism'?",
    answer:
      "Print capitalism refers to the combination of capitalism and print technology that led to the rise of newspapers, books and printed materials as commercial products. It transformed ideas and information into mass-produced commodities, enabling the spread of nationalism.",
    marks: 1,
    type: "1mark",
  },
  {
  ...
  },
  {
    ...
    answer:
      "The National Liberal Party under Chancellor Otto von Bismarck of Prussia led German unification through a policy of 'blood and iron' (wars against Denmark, Austria, and France), culminating in the proclamation of the German Empire in 1871.",
    marks: 1,
    type: "1mark",
  },
  {
    ...
    year: 2022,
    question:
      "Explain the 'Rowlatt Act' and its impact on the Indian freedom struggle.",
    answer:
  ...
  },
  {
    ...
    answer:
      "Globalisation is the process of rapid integration and interconnection between countries through trade, investment, technology and the movement of people.",
    marks: 1,
    type: "1mark",
  },
  {
...
const englishQuestions: PYQQuestion[] = [
  {
    id: "eng-2023-1",
    year: 2023,
    question: "What message does the poem 'Fire and Ice' convey?",
    answer:
      "The poem conveys that the world could end either in fire (desire/greed) or ice (hatred/indifference). The poet uses fire and ice as metaphors for destructive human emotions.",
    marks: 2,
    type: "2mark",
  },
  {
  ...
  },
  {
    ...
    year: 2022,
    question:
      "How is the poet's grandmother described in 'My Mother at Sixty-six'?",
    answer:
      "In the poem by Kamala Das, the poet's mother (not grandmother) is described as: pale and wan like a 'late winter's moon', with an ashen face. The simile emphasises her old age, fading vitality and closeness to death. She sits beside her daughter in the car, mouth open, eyes closed — like a corpse. The poet feels familiar childhood fear of losing her mother.",
    marks: 2,
    type: "2mark",
  },
  {
  ...
  },
  {
    ...
    answer:
      "The young seagull was afraid to fly because he feared that his wings would not support him over the vast sea and he might fall into the water.",
    marks: 2,
    type: "2mark",
  },
  {
...
export const pyqSubjects: PYQSubjectData[] = [
  {
    id: "science",
    label: "Science",
    slug: "science",
    ...
    metaDescription:
      "Free Class 10 Science CBSE Previous Year Questions 2021-2023 with detailed answers. Covers Light, Electricity, Life Processes, Chemical Reactions & more.",
    keywords: [
  ...
  },
  {
    ...
    metaTitle:
      "Class 10 Maths PYQ 2023 — CBSE Previous Year Questions with Solutions",
    metaDescription:
      "Free Class 10 Maths CBSE Previous Year Questions 2021-2023 with step-by-step solutions. HCF LCM, Quadratics, Probability, Trigonometry, Arithmetic Progressions.",
    keywords: [
      "class 10 maths PYQ",
  ...
  },
  {
    ...
    metaTitle:
      "Class 10 SST PYQ 2023 — CBSE Social Science Previous Year Questions",
    metaDescription:
      "Free Class 10 Social Science CBSE Previous Year Questions 2021-2023 with answers. History, Geography, Civics & Economics — all chapters covered.",
    keywords: [
  ...
  },
  {
    ...
    metaDescription:
      "Free Class 10 English CBSE Previous Year Questions 2021-2023 with answers. First Flight, Footprints Without Feet — prose and poetry questions explained.",
    keywords: [
...
export function getPYQBySlug(slug: string): PYQSubjectData | undefined {
